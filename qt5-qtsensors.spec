...
%description
Qt5 Sensors libraries.

%package devel
Summary:	The Qt5 Sensors - development files
...
%package doc
Summary:	The Qt5 Sensors - docs
Group:		Documentation

%description doc
Qt5 Sensors - documentation.
...
%attr(755,root,root) %ghost %{_libdir}/libQt5Sensors.so.?
